   ...
   <body>
      <div class="contain">
         <div class="normal col-4 col-lg-4">
            <img id="image" class="img-responsive" alt="img_bakground" src="{{asset('assets/images/bg.png')}}">
            <img id="overlay" class="img-responsive" alt="img_overlay" src="{{asset('assets/images/overlay.png')}}">
            <img id="arrow" alt="fleche" src="{{asset('assets/images/fleche.png')}}">
            <h1>Retour</h1>
         ...
         <div class="form col-8 col-lg-8">
            ...
            <p id="space">Veuillez renseigner les informations ci-dessous</p>
            <form class="require" method='POST'action='{{ route('contact.email') }}' onsubmit="if(document.getElementById('agree').checked) { return true; } else { alert('Please indicate that you have read and agree to the Terms and Conditions and Privacy Policy'); return false; }" novalidate>
            {{ csrf_field() }}
            <p id="inline">vous etes :</p>
            <input type="radio" name="genre" id="Mr" value="Mr" checked="checked">
            ...
            <label for="psw">Show Password</label>
            ...
            @endif
            <input type="checkbox" onclick="myOtherFunction()">
            <label for="psw">Show Password</label>
            <br>
            ...
            <input  onclick="formcheck();" class="btn btn-dark" style="width:100%" type="submit" value="Creer un Compte">
            </form>
